<?php 
    // คลิปสอน
    // https://www.youtube.com/watch?v=gO2dlj4Eq8I
    ...
    if (isset($_POST['submit'])) {
        $time = time() - 30;    // กำหนดเวลา 30 วินาที
        $ip_address = getIpAddress();  // เก็บค่า IP Address
    ...
    function getIpAddress() { // ฟังก์ชัน get IP Address
